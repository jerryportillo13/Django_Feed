...
@login_required
def friends(request):
    #get admin profile and user profile to create the relationship 
    ...
    #to get eligible profiles -exclude the user their existing freinds and friends requests sent already 
    ...
    # get friend requestes received by the user
    ...
    #check which submit button was pressed (sending request or accepting request)
    ...
    if request.method == 'POST' and request.POST.get("receive_requests"):
        ...
        for sender in senders:
            ...
            #create relationship object to access the senders user id 
            ...
            #add user to their friends list of the senders profile
